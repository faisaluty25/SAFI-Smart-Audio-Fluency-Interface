...
class AudioProcessing:
    ...
    def noise_removal(self, input_path: str, session_id: str):
        ...
        try:
            ...
            output_path = os.path.join(self._create_session_dir(session_id), f"denoised_{session_id}.wav")
    ...
    def text_to_audio(self, text: str, session_id: str):
        try:
            output_path = os.path.join(self._create_session_dir(session_id), f"tts_{session_id}.wav")
    ...
    def transcribe_audio(self, audio_path: str) -> dict:
        return self.whisper_model.transcribe(audio_path, language="en")
    ...
    def process_audio(self, input_audio):
        ...
        try:
            ...
            clean_audio_path = self.generate_audio(cleaned_text, voice_id,
                                                   os.path.join(self._create_session_dir(session_id), f"cleaned_{session_id}.wav"))
